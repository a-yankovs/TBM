// This file contains the sensor reading functions used for the Tunnel Boring Machine (bentonite pump sensor,
// motor temp sensor, and flow monitor), as well as if the emergency stop button 
// was pressed. 
